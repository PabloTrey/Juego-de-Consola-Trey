...
// Declaración arriba del main
 void mostrarResultadoFinales(string nombreJug[2], int puntosTotales[2], int pt[2], int bugs[2], bool llegoCero[2], bool hizo20[2]);
...
// PONER LA SEMILLA ALEATORIA UNA SOLA VEZ
    ...
    while (!salir)
    {
        ...
        case 2:
            ...
            mostrarEstadisticas(  nombreJug , puntosTotales , cantidad);   // MOSTRAR ESTADISTICAS
            pausarPantalla();
            break;
        case 3:
...
// Muestra mensaje de estad�sticas
...
void mostrarResultadoFinales(string nombreJug[], int puntosTotales[], int pt[], int bugs[], bool llegoCero[], bool hizo20[])
{
    ...
    cout << "TREY" << endl;
    cout << "--------------------------------------------------------" << endl;
    cout << "HITO                     " << setw(10) << nombreJug[0] << setw(15) << nombreJug[1] << endl;
    cout << "--------------------------------------------------------" << endl;

    // Puntos base
    cout << "Puntos                  " << setw(4) << puntosTotales[0] << " PTS"
         << setw(10) << puntosTotales[1] << " PTS" << endl;

    // BUGS
    cout << "BUGS                   " << setw(4) << "0 PTS"
     << " (" << bugs[0] << ")" << setw(7)
     << "0 PTS (" << bugs[1] << ")" << endl;

    // Tiempo
    cout << "Tiempo                 " << setw(4) << pt[0]*7 << " PTS"
         << " (" << pt[0] << ")" << setw(7)
         << pt[1]*7 << " PTS (" << pt[1] << ")" << endl;

    // Menor bugs
    cout << "Menor BUGS             " << setw(4)
         << (bugs[0] < bugs[1] ? 7 : (bugs[0] > bugs[1] ? 0 : 7)) << " PTS"
         << setw(11)
         << (bugs[1] < bugs[0] ? 7 : (bugs[1] > bugs[0] ? 0 : 7)) << " PTS" << endl;

    // Llegar a 0 bugs
    cout << "Llegar a 0 BUGS        " << setw(4)
         << (llegoCero[0] ? "15 PTS" : "0 PTS") << setw(15)
         << (llegoCero[1] ? "15 PTS" : "0 PTS") << endl;

    // Acumular 20 puntos
    cout << "Acumular 20 puntos     " << setw(4)
         << (hizo20[0] ? "10 PTS" : "0 PTS") << setw(15)
    ...
    cout << "TOTAL                  " << setw(4) << total0 << " PTS" << setw(15) << total1 << " PTS" << endl;
    cout << endl;
...
int calcularPuntajeFinal(int puntosTotales, int bugs, int pt)
{
    int puntajeFinal = puntosTotales;
    puntajeFinal -= bugs * 5;
    puntajeFinal += pt * 7;
    return puntajeFinal;
}
